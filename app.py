...
def home():
    # Verifica se há um histórico de chat na sessão
    chat_history = request.args.get('chat_history', initialize_chat_history())
            ...
            if len(user_input.split()) > 1:  # Verifica se o usuário digitou mais de uma palavra
                ...
                if results:
                    ...
                    for result in results:
                        chat_history.append(f"📄 <a href='/get_link?title={result['Título do documento']}&chat_history={chat_history}'>{result['Título do documento']}</a>")
                else:
